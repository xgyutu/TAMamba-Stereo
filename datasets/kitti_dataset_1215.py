...
#             # 对左右图像进行等比例填充
#             left_img = left_img.resize((target_width, target_height), Image.BILINEAR)
#             right_img = right_img.resize((target_width, target_height), Image.BILINEAR)
#             # 对深度图进行等比例填充
#             disparity = cv2.resize(disparity, (target_width, target_height), interpolation=cv2.INTER_LINEAR)
#             disparity_low = cv2.resize(disparity, (1280//4, 384//4), interpolation=cv2.INTER_NEAREST)
