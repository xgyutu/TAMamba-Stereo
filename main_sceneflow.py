...
parser = argparse.ArgumentParser(description='TAM-Stereo')
parser.add_argument('--model', default='TAM-Stereo', help='select a model structure', choices=__models__.keys())
...
parser.add_argument('--lrepochs',default="8,11,14,17,20,23,25,27,29,30:2", type=str,  help='the epochs to decay lr: the downscale rate')

parser.add_argument('--logdir', default='./runs/sceneflow/TAM-Stereo', help='the directory to save logs and checkpoints')
